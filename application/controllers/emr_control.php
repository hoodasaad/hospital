...
class Emr_control extends CI_Controller {
    ...
    public function C_index() {
        ...
        $row = $this->emr_model->C_get_contact();
        $this->load->view('emr/add_dr_pationt', $row);
    ...
    public function C_add_user() {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->C_add();
            $this->load->view('emr/add_dr_pationt');
            redirect('emr_control/C_display');
        } else {
    ...
    public function C_display($start = 0) {
        ...
        $config['base_url'] = base_url() . 'index.php/emr_control/C_display/';
        $config['total_rows'] = $this->emr_model->C_Count();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->C_getpationt(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/view_dr', $data);
    }
    ...
    public function C_search() {
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $data['contacts'] = $this->emr_model->C_search();
        $this->load->view('emr/search', $data);
    }
    ...
    private function Menu() {
        $url = base_url() . 'index.php/emr_control/';
        $data['menu'] = [
...
//tabel doc_drug
    public function get_user() {
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $row = $this->emr_model->get_contact();
        $this->load->view('emr/add_pationt_drug', $row);
        $this->load->view('layout/Check', $row);
    }
    ...
    public function add_user() {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->add();
            $this->load->view('emr/add_pationt_drug');
            redirect('emr_control/get_user');
        } else {
            echo validation_errors();
        }
    }
    ...
    public function display($start = 0) {
        ...
        $this->load->model('emr_model');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display/';
        $config['total_rows'] = $this->emr_model->Count();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->getpationt(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/view_pationt_drug', $data);
    }
    ...
    public function ContactDetails($id) {
        ...
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $data['contact'] = $this->emr_model->getContactByID($id);
        $data['patient'] = $this->Patient->Find($data['contact'][0]->mrn);
        $data['diagnosis'] = $this->Admission->LastAdmission($data['contact'][0]->mrn);
        $this->load->view('emr/show_pationt_drug', $data);
    }
    ...
    public function search() {
        ...
        $this->load->model('emr_model');
        $data['contacts'] = $this->emr_model->search();
        $this->load->view('emr/search', $data);
...
//tabel doc_ord
    ...
    public function show_order() {
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $row = $this->emr_model->get_order();
        $this->load->view('emr/add_dr_order', $row);
        $this->load->view('layout/Check', $row);
    }
    ...
    public function add_order() {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->add_order();
            $this->load->view('emr/add_dr_order');
            redirect('emr_control/show_order');
        } else {
            echo validation_errors();
        }
    }
    ...
    public function display_order($start = 0) {
        ...
        $this->load->model('emr_model');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display_order/';
        $config['total_rows'] = $this->emr_model->Count_order();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->get_orders(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/view_dr_order', $data);
    }
    ...
    public function order_Details($id) {
        ...
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $data['contact'] = $this->emr_model->getContactByorder($id);
        $data['patient'] = $this->Patient->Find($data['contact'][0]->mrn);
        $data['diagnosis'] = $this->Admission->LastAdmission($data['contact'][0]->mrn);
        $this->load->view('emr/show_dr_order', $data);
    }
    ...
    public function get_nu() {
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $row = $this->emr_model->get_nu();
        $this->load->view('emr/add_nut', $row);
        $this->load->view('layout/Check', $row);
    }
    ...
    public function add_nu() {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->add_nu();
            $this->load->view('emr/add_nut');
            redirect('emr_control/get_user');
        } else {
            echo validation_errors();
        }
    ...
    public function display_nu($start = 0) {
        ...
        $this->load->model('emr_model');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display_nu/';
        $config['total_rows'] = $this->emr_model->Count_nu();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->get_nus(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/view_nut', $data);
    }
    ...
    public function ContactDetails_nu($id) {
        ...
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $data['contact'] = $this->emr_model->getContactBynu($id);
        $data['patient'] = $this->Patient->Find($data['contact'][0]->mrn);
        $data['diagnosis'] = $this->Admission->LastAdmission($data['contact'][0]->mrn);
        $this->load->view('emr/show_nut', $data);
    }
...
// tabel doc_req
    public function get_req() {
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $row = $this->emr_model->get_req();
        $this->load->view('emr/add_cons', $row);
        $this->load->view('layout/Check', $row);
    }
    ...
    public function add_req() {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->add_req();
            $this->load->view('emr/add_cons');
            redirect('emr_control/get_req');
        } else {
            echo validation_errors();
        }
    }
    ...
    public function display_req($start = 0) {
        ...
        $this->load->model('emr_model');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display_req/';
        $config['total_rows'] = $this->emr_model->Count_req();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->get_reqe(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/view_cons', $data);
    }
    ...
    public function ContactDetails_req($id) {
        ...
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $data['contact'] = $this->emr_model->getContactByreq($id);
        $data['patient'] = $this->Patient->Find($data['contact'][0]->mrn);
        $data['diagnosis'] = $this->Admission->LastAdmission($data['contact'][0]->mrn);
        $this->load->view('emr/show_cons', $data);
    }
    ...
    public function search_req() {
        ...
        $this->load->view('header');
        $this->load->model('emr_model');
        $data['contacts'] = $this->emr_model->search_req();
        $this->load->view('emr/search', $data);
        $this->load->view('footer');
    }
    ...
    public function get_prog() {
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $row = $this->emr_model->get_prog();
        $this->load->view('emr/add_prog', $row);
        $this->load->view('layout/Check', $row);
    }
    ...
    public function add_prog() {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->add_prog();
            $this->load->view('emr/add_prog');
            redirect('emr_control/get_prog');
        } else {
            echo validation_errors();
        }
    }
    ...
    public function display_prog($start = 0) {
        ...
        $this->load->model('emr_model');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display_prog/';
        $config['total_rows'] = $this->emr_model->Count_prog();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->get_progr(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/view_prog', $data);
    }
    ...
    public function ContactDetails_prog($id) {
        ...
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $data['contact'] = $this->emr_model->getContactByprog($id);
        $data['patient'] = $this->Patient->Find($data['contact'][0]->mrn);
        $data['diagnosis'] = $this->Admission->LastAdmission($data['contact'][0]->mrn);
        $this->load->view('emr/show_prog', $data);
    }
    ...
    public function get_rel() {
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $row = $this->emr_model->get_rel();
        $this->load->view('emr/add_patient_relative', $row);
        $this->load->view('layout/Check', $row);
    }
    ...
    public function add_rel() {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->add_rel();
            $this->load->view('emr/add_patient_relative');
            redirect('emr_control/get_rel');
        } else {
            echo validation_errors();
        }
    }
    ...
    public function display_rel($start = 0) {
        ...
        $this->load->model('emr_model');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display_rel/';
        $config['total_rows'] = $this->emr_model->Count_rel();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->get_rel(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/view_patient_relative', $data);
    }
    ...
    public function ContactDetails_rel($id) {
        ...
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $data['contact'] = $this->emr_model->getContactByrel($id);
        $data['patient'] = $this->Patient->Find($data['contact'][0]->mrn);
        $data['diagnosis'] = $this->Admission->LastAdmission($data['contact'][0]->mrn);
        $this->load->view('emr/show_patient_relative', $data);
    }
    ...
    public function search_rel() {
        ...
        $this->load->view('header');
        $this->load->model('emr_model');
        $data['contacts'] = $this->emr_model->search_rel();
        $this->load->view('emr/search', $data);
        $this->load->view('footer');
    }
    ...
    public function get_physical() {
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $row = $this->emr_model->get_physical();
        $this->load->view('emr/add_physical_assment', $row);
        $this->load->view('layout/Check', $row);
    }
    ...
    public function add_physical() {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->add_physical();
            $this->load->view('emr/add_physical_assment');
            redirect('emr_control/get_physical');
        } else {
            echo validation_errors();
        }
    }
    ...
    public function display_physical($start = 0) {
        ...
        $this->load->model('emr_model');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display_physical/';
        $config['total_rows'] = $this->emr_model->Count_physical();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->get_physica(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/view_physical_assment', $data);
    }
    ...
    public function ContactDetails_physical($id) {
        ...
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $data['contact'] = $this->emr_model->getContactByphysical($id);
        $data['patient'] = $this->Patient->Find($data['contact'][0]->mrn);
        $data['diagnosis'] = $this->Admission->LastAdmission($data['contact'][0]->mrn);
        $this->load->view('emr/show_physical_assment', $data);
    }
    ...
    public function search_physical() {
        ...
        $this->load->view('header');
        $this->load->model('emr_model');
        $data['contacts'] = $this->emr_model->search_physical();
        $this->load->view('emr/search', $data);
        $this->load->view('footer');
    }
...
// tabel doc_insulin
    public function get_insulin() {
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $row = $this->emr_model->get_insulin();
        $this->load->view('emr/add_insulin', $row);
        $this->load->view('layout/Check', $row);
    }
    ...
    public function add_insulin() {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->add_insulin();
            $this->load->view('emr/add_physical_assment');
            redirect('emr_control/get_insulin');
        } else {
            echo validation_errors();
        }
    }
    ...
    public function display_insulin($start = 0) {
        ...
        $this->load->model('emr_model');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display_insulin/';
        $config['total_rows'] = $this->emr_model->Count_insulin();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->get_insuli(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/view_insulin', $data);
    }
    ...
    public function ContactDetails_insulin($id) {
        ...
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $data['contact'] = $this->emr_model->getContactByinsulin($id);
        $data['patient'] = $this->Patient->Find($data['contact'][0]->mrn);
        $data['diagnosis'] = $this->Admission->LastAdmission($data['contact'][0]->mrn);
        $this->load->view('emr/show_insulin', $data);
    }

    public function search_insulin() {

        $this->load->model('emr_model');
        $data['contacts'] = $this->emr_model->search_insulin();
        $this->load->view('emr/search', $data);
    }
    ...
    public function get_discharge() {
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $row = $this->emr_model->get_discharge();
        $this->load->view('emr/add_discharge_summary', $row);
        $this->load->view('layout/Check', $row);
    }
    ...
    public function add_discharge() {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->add_discharge();
            $this->load->view('emr/add_discharge_summary');
            redirect('emr_control/get_discharge');
        } else {
            echo validation_errors();
        }
    }
    ...
    public function display_discharge($start = 0) {
        ...
        $this->load->model('emr_model');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display_discharge/';
        $config['total_rows'] = $this->emr_model->Count_discharge();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->get_discharg(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/view_discharge_summary', $data);
    }
    ...
    public function ContactDetails_discharge($id) {
        ...
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $data['contact'] = $this->emr_model->getContactBydischarge($id);
        $data['patient'] = $this->Patient->Find($data['contact'][0]->mrn);
        $data['diagnosis'] = $this->Admission->LastAdmission($data['contact'][0]->mrn);
        $this->load->view('emr/show_discharge_summary', $data);
    }
    ...
    public function BloodRequests($start = 0) {
        ...
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/BloodRequests/';
        $config['total_rows'] = $this->BloodTramsFusion->Count();
        $config['per_page'] = 5;
        $this->pagination->initialize($config);
        $data['All'] = $this->BloodTramsFusion->GetPagination(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/BloodRequests', $data);
    }

    public function AddBloodRequest() {
        $this->load->view('layout/style');
        $this->load->model('BloodTramsFusion');
        $this->load->view('emr/inc/AddBloodRequest');
    ...
    public function CreateBloodRequest() {
        ...
        if ($this->form_validation->run()) {
            ...
            if ($create) {
                ...
                redirect('emr_control/BloodRequests');
            } else {
    ...
    public function ShowBloodRequest($id) {
        ...
        $this->load->view('emr/inc/ShowBloodRequest', $data);
    }
    ...
    public function AddMonitorRing($id) {
        ...
        $this->load->view('emr/inc/AddMonitorRing', $data);
    }
    ...
    public function get_voise($id) {
        ...
        $this->load->model('emr_model');
        $row ['id'] = $id;
        $this->load->view('emr/add_voise_order', $row);
        $this->load->view('layout/Check', $row);
    }
    ...
    public function add_voise($id) {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->add_voise($id);
            $this->load->view('emr/add_voise_order');
            redirect('emr_control/get_voise/' . $id);
        } else {
            echo validation_errors();
        }
    }
    ...
    public function display_voise($start = 0) {
        ...
        $this->load->model('emr_model');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display_voise/';
        $config['total_rows'] = $this->emr_model->Count_voise();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->getvoise(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/view_voise_order', $data);
    }
    ...
    public function ContactDetails_voise($id) {
        ...
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $data['contact'] = $this->emr_model->getContactByvoise($id);
        $data['patient'] = $this->Patient->Find($data['contact'][0]->mrn);
        $data['diagnosis'] = $this->Admission->LastAdmission($data['contact'][0]->mrn);
        $this->load->view('emr/show_voise_order', $data);
    }

    public function search_voise() {

        $this->load->model('emr_model');
        $data['contacts'] = $this->emr_model->search_voise();
        $this->load->view('emr/search', $data);
    }
    ...
    public function get_need() {
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $row = $this->emr_model->get_need();
        $this->load->view('emr/add_drug', $row);
        $this->load->view('layout/Check');
    }
    ...
    public function add_need() {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->add_need();
            $this->load->view('emr/add_drug');
            redirect('emr_control/get_need');
        } else {
            echo validation_errors();
        }
    }
    ...
    public function display_need($start = 0) {
        ...
        $this->load->model('emr_model');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display_need/';
        $config['total_rows'] = $this->emr_model->Count_need();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->getneed(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/view_drug', $data);
    }
    ...
    public function ContactDetails_need($id) {
        ...
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $data['contact'] = $this->emr_model->getContactByneed($id);
        $data['patient'] = $this->Patient->Find($data['contact'][0]->mrn);
        $data['diagnosis'] = $this->Admission->LastAdmission($data['contact'][0]->mrn);
        $this->load->view('emr/show_drug', $data);
    }

    public function search_need() {

        $this->load->model('emr_model');
        $data['contacts'] = $this->emr_model->search_need();
        $this->load->view('emr/search', $data);
    }
...
// tabel doc_fluid
    public function get_fluid() {
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $row = $this->emr_model->get_fluid();
        $this->load->view('emr/add_fluid', $row);
        $this->load->view('layout/Check');
    }
    ...
    public function add_fluid() {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->add_fluid();
            $this->load->view('emr/add_fluid');
            redirect('emr_control/get_fluid');
        } else {
            echo validation_errors();
        }
    }
    ...
    public function display_fluid($start = 0) {
        ...
        $this->load->model('emr_model');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display_fluid/';
        $config['total_rows'] = $this->emr_model->Count_fluid();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->getfluid(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/view_fluid', $data);
    }
    ...
    public function ContactDetails_fluid($id) {
        ...
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $data['contact'] = $this->emr_model->getContactByfluid($id);
        $data['patient'] = $this->Patient->Find($data['contact'][0]->mrn);
        $data['diagnosis'] = $this->Admission->LastAdmission($data['contact'][0]->mrn);
        $this->load->view('emr/show_fluid', $data);
    }

    public function search_fluid() {

        $this->load->model('emr_model');
        $data['contacts'] = $this->emr_model->search_fluid();
        $this->load->view('emr/search', $data);
    }
    ...
    public function get_fluid_chart($id) {
        ...
        $this->load->model('emr_model');
        $row['id'] = $id;
        $this->load->view('emr/add_fluid_chart', $row);
        $this->load->view('layout/Check');
    }
    ...
    public function add_fluid_chart($id) {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->add_fluid_chart($id);
            $this->load->view('emr/add_fluid_chart');
            redirect('emr_control/get_fluid_chart/' . $id);
        } else {
            echo validation_errors();
        }
    }
    ...
    public function display_fluid_chart($start = 0) {
        ...
        $this->load->model('emr_model');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display_fluid_chart/';
        $config['total_rows'] = $this->emr_model->Count_fluid_chart();
        $config['total_rows'] = $this->emr_model->Count_fluid();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->getfluid(12, $start);
        $data['nur'] = $this->emr_model->getfluidchart(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/view_fluid_chart', $data);
    }
    ...
    public function get_rad() {
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $row = $this->emr_model->get_rad();
        $this->load->view('emr/add_rad', $row);
        $this->load->view('layout/Check', $row);
    }
    ...
    public function add_rad() {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->add_rad();
            $this->load->view('emr/add_rad');
            redirect('emr_control/get_rad');
        } else {
            echo validation_errors();
        }
    }
    ...
    public function display_rad($start = 0) {
        ...
        $this->load->model('emr_model');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display_rad/';
        $config['total_rows'] = $this->emr_model->Count_rad();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->getrad(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/view_rad', $data);
    }
    ...
    public function ContactDetails_rad($id) {
        ...
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $data['contact'] = $this->emr_model->getContactByrad($id);
        $data['patient'] = $this->Patient->Find($data['contact'][0]->mrn);
        $data['diagnosis'] = $this->Admission->LastAdmission($data['contact'][0]->mrn);
        $this->load->view('emr/show_rad', $data);
    }

    public function search_rad() {

        $this->load->model('emr_model');
        $data['contacts'] = $this->emr_model->search_rad();
        $this->load->view('emr/search', $data);
    }
    ...
    public function get_lab() {
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $row = $this->emr_model->get_lab();
        $this->load->view('emr/add_lab', $row);
        $this->load->view('layout/Check', $row);
    }
    ...
    public function add_lab() {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->add_lab();
            $this->load->view('emr/add_lab');
            redirect('emr_control/get_lab');
        } else {
            echo validation_errors();
        }
    }
    ...
    public function display_lab($start = 0) {
        ...
        $this->load->model('emr_model');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display_lab/';
        $config['total_rows'] = $this->emr_model->Count_lab();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->getlab(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/view_lab', $data);
    }
    ...
    public function ContactDetails_lab($id) {
        ...
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $data['contact'] = $this->emr_model->getContactBylab($id);
        $data['patient'] = $this->Patient->Find($data['contact'][0]->mrn);
        $data['diagnosis'] = $this->Admission->LastAdmission($data['contact'][0]->mrn);
        $this->load->view('emr/show_lab', $data);
    }

    public function search_lab() {

        $this->load->model('emr_model');
        $data['contacts'] = $this->emr_model->search_lab();
        $this->load->view('emr/search', $data);
    }
    ...
    public function get_risk() {
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $row = $this->emr_model->get_risk();
        $this->load->view('emr/add_risk', $row);
        $this->load->view('layout/Check', $row);
    }
    ...
    public function add_risk() {
        ...
        if ($this->form_validation->run()) {
            ...
            $this->Risk->Create();
            //$this->load->view('emr/add_risk');
            redirect('emr_control/display_risk');
        } else {
            echo validation_errors();
        }
    }
    ...
    public function display_risk($start = 0) {
        ...
        $this->load->model('Risk');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display_risk/';
        $config['total_rows'] = $this->Risk->Count();
        $config['per_page'] = 5;
        $this->pagination->initialize($config);
        $data['All'] = $this->Risk->GetPagination(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/risk/showRisk', $data);
    }
    ...
    public function ContactDetails_risk($id) {
        ...
        $this->load->view('emr/risk/findRisk', $data);
    }
    ...
    public function get_ana() {
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $row = $this->emr_model->get_ana();
        $this->load->view('emr/ana/add_anasthia', $row);
        $this->load->view('layout/Check', $row);
    }
    ...
    public function add_ana() {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->add_ana();
            $this->load->view('emr/ana/add_anasthia');
            redirect('emr_control/get_ana');
        } else {
            echo validation_errors();
        }
    }
    ...
    public function display_ana($start = 0) {
        ...
        $this->load->model('emr_model');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display_ana/';
        $config['total_rows'] = $this->emr_model->Count_ana();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->getana(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/ana/view_anasthia', $data);
    }
    ...
    public function ContactDetails_ana($id) {
        ...
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $data['contact'] = $this->emr_model->getContactByana($id);
        $data['patient'] = $this->Patient->Find($data['contact'][0]->mrn);
        $data['diagnosis'] = $this->Admission->LastAdmission($data['contact'][0]->mrn);
        $this->load->view('emr/ana/show_anasthia', $data);
    }
    ...
    public function get_clinical() {
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $row = $this->emr_model->get_clinical();
        $this->load->view('emr/ana/add_clinical', $row);
        $this->load->view('layout/Check', $row);
    }
    ...
    public function add_clinical() {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->add_clinical();
            $this->load->view('emr/ana/add_clinical');
            redirect('emr_control/get_clinical');
        } else {
            echo validation_errors();
        }
    }
    ...
    public function display_clinical($start = 0) {
        ...
        $this->load->model('emr_model');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display_clinical/';
        $config['total_rows'] = $this->emr_model->Count_clinical();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->getclinical(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/ana/view_clinical', $data);
    }
    ...
    public function ContactDetails_clinical($id) {
        ...
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $data['contact'] = $this->emr_model->getContactByclinical($id);
        $data['patient'] = $this->Patient->Find($data['contact'][0]->mrn);
        $data['diagnosis'] = $this->Admission->LastAdmission($data['contact'][0]->mrn);
        $this->load->view('emr/ana/show_clinical', $data);
    }

    public function search_clinical() {

        $this->load->model('emr_model');
        $data['contacts'] = $this->emr_model->search_clinical();
        $this->load->view('emr/search', $data);
    }
    ...
    public function get_operative() {
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $row = $this->emr_model->get_operative();
        $this->load->view('emr/sur/add_operative', $row);
        $this->load->view('layout/Check', $row);
    }
    ...
    public function add_operative() {
        ...
        if ($this->form_validation->run()) {
            $this->load->model('emr_model');
            $this->emr_model->add_operative();
            $this->load->view('emr/sur/add_operative');
            redirect('emr_control/get_operative');
        } else {
            echo validation_errors();
        }
    }
    ...
    public function display_operative($start = 0) {
        ...
        $this->load->model('emr_model');
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/display_operative/';
        $config['total_rows'] = $this->emr_model->Count_operative();
        $config['per_page'] = 5;

        $this->pagination->initialize($config);
        $data['phone'] = $this->emr_model->getoperative(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/sur/view_operative', $data);
    }
    ...
    public function ContactDetails_operative($id) {
        ...
        $this->load->view('layout/style');
        $this->load->model('emr_model');
        $data['contact'] = $this->emr_model->getContactByoperative($id);
        $data['patient'] = $this->Patient->Find($data['contact'][0]->mrn);
        $data['diagnosis'] = $this->Admission->LastAdmission($data['contact'][0]->mrn);
        $this->load->view('emr/sur/show_operative', $data);
    }

    public function search_operative() {

        $this->load->model('emr_model');
        $data['contacts'] = $this->emr_model->search_operative();
        $this->load->view('emr/search', $data);
    }
    ...
    public function RecordAnesthesia($start = 0) {
        ...
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/RecordAnesthesia/';
        $config['total_rows'] = $this->Records->Count();
        $config['per_page'] = 5;
        $this->pagination->initialize($config);
        $data['All'] = $this->Records->GetPagination(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/Records/Records', $data);
    }

    public function AddRecord() {
        $this->load->view('layout/style');
        $this->load->view('emr/Records/inc/AddRecord');
        $this->load->view('layout/Check');
    }
    ...
    public function CreateRecord() {
        ...
        if ($add) {
            redirect('emr_control/RecordAnesthesia');
        } else {
            redirect($this->back);
        }
    }
    ...
    public function FindRecord($id) {
        ...
        $this->load->view('emr/Records/inc/FindRecord', $data);
    }
    ...
    public function Recovery($start = 0) {
        ...
        $this->load->library('pagination');
        $config['base_url'] = base_url() . 'index.php/emr_control/Recovery/';
        $config['total_rows'] = $this->Recovery->Count();
        $config['per_page'] = 5;
        $this->pagination->initialize($config);
        $data['All'] = $this->Recovery->GetPagination(12, $start);
        $data['links'] = $this->pagination->create_links();
        $this->load->view('emr/Recovery/Recovery', $data);
    }

    public function AddRecovery() {
        $this->load->view('layout/style');
        $this->load->view('emr/Recovery/inc/AddRecovery');
        $this->load->view('layout/Check');
    }
    ...
    public function FindRecovery($id) {
        ...
        $this->load->view('emr/Recovery/inc/FindRecovery', $data);
    }
