...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="block">
                <div class="block-title"><span class="glyphicon glyphicon-user"></span> Add New Nursing Notes</div>
                <div class="block-content">
                    <?php echo form_open('nurse_control/add_notes') ?>
                    <div id="MRN-INFO"></div>                 
                    ...
                    <div class="form-group">
                        <label class="mws-form-label">Notes & Intervention</label>
