                    ...
                    <tbody>
                        <?php foreach ($phone as $row) { ?>
                            <tr>
                                ...
                                <td><a href=" <?php echo base_url() ?>index.php/nurse_control/get_need/<?php echo $row->id ?>">Nurse Sign</a></td>
                                <td><a href=" <?php echo base_url() ?>index.php/nurse_control/ContactDetails_need/<?php echo $row->id ?>">Show</a></td>
                            </tr>
                        <?php }
                        ?>
