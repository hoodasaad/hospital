        ...
        <div class="col-xs-12">
            <div class="block">
                ...
                <div class="block-content">
                    ...
                    <?php echo form_open('nurse_control/add_voise') ?>
                    <div id="MRN-INFO"></div>                 
                    ...
                    <div class="form-group">
                        ...
                        <input type='text' placeholder='Dr Order' name='dr_order' class="form-control"/>
                    </div>
                    <div class="form-group">
                        <label class="mws-form-label">Nurse Recived Order </label>
                        <input type='text' placeholder='Nurse Recived Order' name='nurse' class="form-control"/>
                    </div>
