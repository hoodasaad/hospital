        ...
        <div class="col-xs-12">
            ...
            <div class="block">
                <div class="block-title"><span class="glyphicon glyphicon-user"></span> Add New Record
                    <a class="btn btn-info btn-sm" href="<?= base_url() ?>index.php/emr_control/RecordAnesthesia"><span
                            class="glyphicon glyphicon-eye-open"></span></a></div>
                <div class="block-content">
                    <form class="form" role="form" action="<?= base_url() ?>index.php/emr_control/CreateRecord"
                          method="post">
                        <div id="MRN-INFO"></div>
