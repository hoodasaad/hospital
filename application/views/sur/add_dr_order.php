<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="block">
                <div class="block-title"><span class="glyphicon glyphicon-user"></span> Add New Doctor Order</div>
                <div class="block-content">
                    <?php echo form_open('sur_control/add_order') ?>
                    <div id="MRN-INFO"></div>                 
                    ...
                    <div class="form-group">
                        <label class="mws-form-label">Doctor Order</label>
                        <textarea placeholder='Doctor Order' name='order' class="form-control"></textarea>
                    </div>
                    <div class="form-group">
                        <label class="mws-form-label">Doctor Signature</label>
                        <input type='text' placeholder='Doctor Order' name='sign' class="form-control"/>
                    </div>
