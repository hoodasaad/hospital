        ...
        <div class="col-xs-12">
            ...
            <div class="block">
                <div class="block-title"><span class="glyphicon glyphicon-user"></span> Add New Recovery
                    <a class="btn btn-info btn-sm" href="<?= base_url() ?>index.php/sur_control/Recovery"><span
                            class="glyphicon glyphicon-eye-open"></span></a></div>
                <div class="block-content">
                    <form class="form" role="form" action="<?= base_url() ?>index.php/sur_control/CreateRecovery"
                          method="post">
                        <div id="MRN-INFO"></div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <span id="btn-sub" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus"></span> </span>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <span id="btn-sub2" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus"></span> </span>
                        </div>
                        <div class="form-group">
...
<script>
    $("#btn-sub").click(function(){
       var x = '<tr><td> <div class="form-inline"> <div class="input-group"> <input type="text" id="Temp" class="form-control" name="temp[]" placeholder="Temp"> <div class="input-group-addon"> &deg; C </div></div></div></td><td><input type="text" class="form-control" name="pulse[]" placeholder="Pulse"></td><td><input type="text" class="form-control" name="bl_p[]" placeholder="BL.p"></td><td><input type="text" class="form-control" name="resp[]" placeholder="Resp"></td><td><input type="text" class="form-control" name="ox_p[]" placeholder="Ox.p"></td></tr>';
        $("#Vital").append(x);
    });

    $("#btn-sub2").click(function(){
       var x = '<tr><td><input type="text" name="type[]" class="form-control" placeholder="Type"></td> <td><input type="text" name="dose[]" class="form-control" placeholder="Dose"></td> <td><input type="text" name="rate[]" class="form-control" placeholder="Rate"></td> </tr>';
