        ...
        <div id="mws-wrapper">
            ...
            <div id="mws-sidebar">
                ...
                <div id="mws-searchbox" class="mws-inset">
                    <?php echo form_open('cons_control/search'); ?>
                    <input type="text" class="mws-search-input" placeholder="Search by Mrn..." name="search" id="search">
                ...
                <div id="mws-navigation">
                    <ul>
                        <li class="active"><a href="<?php echo base_url(); ?>index.php/cons_control/index"><i class="icon-home"></i> Consultant Dashboard</a></li>
                        <li><a href="<?php echo base_url(); ?>index.php/cons_control/index"><i class="icon-install"></i> Add New Patient</a></li>
                        <li><a href="<?php echo base_url(); ?>index.php/cons_control/display"><i class="icon-television"></i> Show All Patient</a></li>
