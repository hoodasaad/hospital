...
class Dr_model extends CI_Model {
    ...
    public function add_order() {
        ...
        $this->db->insert('doc_ord', $data);
    }

    public function Count_order() {
        return $this->db->count_all("doc_ord");
    }
...
//tabel doc_ rel
    ...
    public function add_rel() {
        ...
        $this->db->insert('doc_rel', $data);
    }

    public function Count_rel() {
        return $this->db->count_all("doc_rel");
    }
...
// tabel doc_nu
    ...
    public function add_req() {
        ...
        $this->db->insert('doc_req', $data);
    }

    public function Count_req() {
        return $this->db->count_all("doc_req");
    }
    ...
    public function add_prog() {
        ...
        $this->db->insert('doc_prog', $data);
    }

    public function Count_prog() {
        return $this->db->count_all("doc_prog");
    }
    ...
    public function get_physical() {
        $query = $this->db->get('doc_physical');
        return $query->result();
    }
    ...
    public function add_physical() {
        ...
        $this->db->insert('doc_physical', $data);
    }

    public function Count_physical() {
        return $this->db->count_all("doc_physical");
    }
...
// tabel doc_insulin
    ...
    public function add_insulin() {
        ...
        $this->db->insert('doc_insulin', $data);
    }

    public function Count_insulin() {
        return $this->db->count_all("doc_insulin");
    }
...
// tabel doc_discharge
    public function get_discharge() {
        $query = $this->db->get('doc_discharge');
        return $query->result();
    }
    ...
    public function add_discharge() {
        ...
        $this->db->insert('doc_discharge', $data);
    }

    public function Count_discharge() {
        return $this->db->count_all("doc_discharge");
    }
...
// tabel doc_fluid
    ...
    public function get_fluid_chart() {
        $query = $this->db->get('doc_fluid_chart');
        return $query->result();
    }
    ...
    public function add_fluid_chart($id) {
        ...
        $this->db->insert('doc_fluid_chart', $data);
    }

    public function Count_fluid_chart() {
        $data['doc'] = $this->db->count_all("doc_fluid");
    ...
    public function add_rad() {
        ...
        $this->db->insert('doc_rad', $data);
    }

    public function Count_rad() {
        return $this->db->count_all("doc_rad");
    }
...
// tabel doc_lab
    ...
    public function add_lab() {
        ...
        $this->db->insert('doc_lab', $data);
    }

    public function Count_lab() {
        return $this->db->count_all("doc_lab");
    }
    ...
    public function add_ana() {
        ...
        $this->db->insert('doc_ana', $data);
    }

    public function Count_ana() {
        return $this->db->count_all("doc_ana");
    }
    ...
    public function get_clinical() {
        $query = $this->db->get('doc_clinical');
        return $query->result();
    }
    ...
    public function add_clinical() {
        ...
        $this->db->insert('doc_clinical', $data);
    }

    public function Count_clinical() {
        return $this->db->count_all("doc_clinical");
    }
    ...
    public function get_operative() {
        $query = $this->db->get('doc_operative');
        return $query->result();
    }
    ...
    public function add_operative() {
        ...
        $this->db->insert('doc_operative', $data);
    }

    public function Count_operative() {
        return $this->db->count_all("doc_operative");
    }
