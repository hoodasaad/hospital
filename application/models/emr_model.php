...
class Emr_model extends CI_Model {
    ...
    public function add() {
        ...
        $this->db->insert('emr_drug', $data);
    }

    public function Count() {
        return $this->db->count_all("emr_drug");
    }
    ...
    public function add_order() {
        ...
        $this->db->insert('emr_ord', $data);
    }

    public function Count_order() {
        return $this->db->count_all("emr_ord");
    }
...
//tabel emr_ rel
    ...
    public function add_rel() {
        ...
        $this->db->insert('emr_rel', $data);
    }

    public function Count_rel() {
        return $this->db->count_all("emr_rel");
    }
...
// tabel emr_nu
    ...
    public function add_nu() {
        ...
        $this->db->insert('emr_nu', $data);
    }

    public function Count_nu() {
        return $this->db->count_all("emr_nu");
    }
    ...
    public function add_req() {
        ...
        $this->db->insert('emr_req', $data);
    }

    public function Count_req() {
        return $this->db->count_all("emr_req");
    }
    ...
    public function add_prog() {
        ...
        $this->db->insert('emr_prog', $data);
    }

    public function Count_prog() {
        return $this->db->count_all("emr_prog");
    }
    ...
    public function get_physical() {
        $query = $this->db->get('emr_physical');
        return $query->result();
    }
    ...
    public function add_physical() {
        ...
        $this->db->insert('emr_physical', $data);
    }

    public function Count_physical() {
        return $this->db->count_all("emr_physical");
    }
...
// tabel emr_insulin
    ...
    public function add_insulin() {
        ...
        $this->db->insert('emr_insulin', $data);
    }

    public function Count_insulin() {
        return $this->db->count_all("emr_insulin");
    }
...
// tabel emr_discharge
    public function get_discharge() {
        $query = $this->db->get('emr_discharge');
        return $query->result();
    }
    ...
    public function add_discharge() {
        ...
        $this->db->insert('emr_discharge', $data);
    }

    public function Count_discharge() {
        return $this->db->count_all("emr_discharge");
    }
    ...
    public function add_need() {
        ...
        $this->db->insert('emr_need', $data);
    }

    public function Count_need() {
        return $this->db->count_all("emr_need");
    }
...
// tabel emr_fluid
    ...
    public function add_fluid() {
        ...
        $this->db->insert('emr_fluid', $data);
    }

    public function Count_fluid() {
        return $this->db->count_all("emr_fluid");
    }
    ...
    // tabel emr_fluid_chart
    public function get_fluid_chart() {
        $query = $this->db->get('emr_fluid_chart');
        return $query->result();
    }
    ...
    public function add_fluid_chart($id) {
        ...
        $this->db->insert('emr_fluid_chart', $data);
    }

    public function Count_fluid_chart() {
        $data['doc'] = $this->db->count_all("emr_fluid");
    ...
    public function add_rad() {
        ...
        $this->db->insert('emr_rad', $data);
    }

    public function Count_rad() {
        return $this->db->count_all("emr_rad");
    }
...
// tabel emr_lab
    ...
    public function add_lab() {
        ...
        $this->db->insert('emr_lab', $data);
    }

    public function Count_lab() {
        return $this->db->count_all("emr_lab");
    }
    ...
    public function add_ana() {
        ...
        $this->db->insert('emr_ana', $data);
    }

    public function Count_ana() {
        return $this->db->count_all("emr_ana");
    }
    ...
    public function get_clinical() {
        $query = $this->db->get('emr_clinical');
        return $query->result();
    }
    ...
    public function add_clinical() {
        ...
        $this->db->insert('emr_clinical', $data);
    }

    public function Count_clinical() {
        return $this->db->count_all("emr_clinical");
    }
    ...
    public function get_operative() {
        $query = $this->db->get('emr_operative');
        return $query->result();
    }
    ...
    public function add_operative() {
        ...
        $this->db->insert('emr_operative', $data);
    }

    public function Count_operative() {
        return $this->db->count_all("emr_operative");
    }
